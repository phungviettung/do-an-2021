        ...
        <>
            <div className={color}>
                <div className="ibox-body">
                    ...
                    <div className="m-b-5">Shipping</div><i className="ti-shopping-cart widget-stat-icon"><ShoppingCartOutlined /></i>
                    <div><i className="fa fa-level-up m-r-5">
                        {per > 0 ? <UpOutlined /> : <DownOutlined />} 
                    </i><small> {per}% {hightLow} </small></div>
                </div>
            </div>
        </>
    );
...
export default connect(mapStateToProps, {  })(WidgetShipping);
